classdef photometry
    ...
    enumeration
        ...
        % HK  ( (1.654e-6*1.1e12+2.179e-6*7.0e11)/(1.1e12+7.0e11) , 0.290e-6+0.410e-6 , 1.1e12+7.0e11 )
        % JH  ( (1.215e-6*1.9e12+1.654e-6*1.1e12)/(1.9e12+1.1e12) , 0.260e-6+0.290e-6 , 1.9e12+1.1e12 )
        % JHK ( (1.215e-6*1.9e12+1.654e-6*1.1e12+2.179e-6*7.0e11)/(1.9e12+1.1e12+7.0e11) , 0.260e-6+0.290e-6+0.410e-6 , 1.9e12+1.1e12+7.0e11 )
        z   ( 0.945e-6 , 0.25e-6 , 2.7e12 )
        Y   ( 1.020e-6 , 0.16e-6 , 1.7e12 )
        zJ  ( 1.056e-6 , 0.51e-6 , 4.6e12 )
        YJ  ( 1.123e-6 , 0.42e-6 , 3.6e12 )
        JH  ( 1.376e-6 , 0.55e-6 , 3.0e12 )
        HKs  ( 1.822e-6 , 0.61e-6 , 1.65e12 )
    end
