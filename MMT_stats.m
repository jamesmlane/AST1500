...
for mmm = 1:length(magVec)
    ...
    switch dmType
        case 'ASM'
            load AOSim2/data/MMT_DM336_Actuators.mat
            nAct = length(ACT);
    ...
    str = strcat('MMT_exploration/Results/noNoise/higherRes/',num2str(wfsType),'_',num2str(modeType),'_nThresh',num2str(nThresholded),'_',num2str(magTmp),'mag_',Band,'band','_modulation',num2str(modulation));
