...
for i = 1:length(magnitudeVector)
    ...
    outputStr = strcat(outputPath,num2str(wfsType),'_',num2str(modeType),'_nThresh',num2str(nThresholded),'_',num2str(magTmp),'mag_',Band,'band','_modulation',num2str(modulation));
